...
# Portable Python on Windows uses a ._pth file that does not put the script
# directory on sys.path, so local modules beside this file must be added explicitly.
