...
/** Backends and the login form use short role names; the store uses canonical ones. */
...
function toAppRole(value: string | null | undefined): AppRole {
  ...
  return ROLE_ALIASES[value.trim().toUpperCase()] ?? "VIEWER";
}
